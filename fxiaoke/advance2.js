...
page.onCallback = function(adLinks) {
    ...
    adLinks.forEach(function(link){
        ...
        tempPage.customHeaders=tempPageHeaders;
        ...
        tempPage.onResourceRequested = function (request) {
            //console.log('Request ' + JSON.stringify(request, undefined, 4));
        };
        tempPage.onResourceReceived = function (response) {
            tempPage.cookies.forEach(function(cookieData){
                phantom.addCookie(cookieData);
            });
        };
    });
